...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-gray-50   p-4  w-full ">
            <div className="m-4">
                <button className="rounded-full bg-gray-700 p-2 text-2xl">
                    ...
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-blue-950 rounded-lg shadow-md m-4 p-4 text-white">
                            ...
                            <div className="flex justify-between my-2">
                                <Link to={`edit/${el.id}`}>
                                    <button className="rounded p-2 bg-cyan-100 text-black">

                                        Edit
                                    </button>
                                </Link>

                                <button onClick={() => dispatch(removeContact(el.id))} className="rounded p-2 bg-orange-600 text-white">Delete</button>
                            </div>
                        </div>
                    })
                }
