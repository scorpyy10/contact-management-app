...
const Dashboard = () => {
  ...
  return (
    <div className="  w-full pt-20 px-4 pb-8" >
      <h1 className="text-4xl font-bold mb-4 text-orange-600">Corona Cases Chart</h1>
      <div className="border-2 border-red-100 w-11/12  m-auto 10 auto 10" >

        {
          chartData.datasets ?
            <Line data={chartData} /> : <h1 className="text-orange-600 mb-4 font-bold text-2xl">Loading...</h1>
        }
